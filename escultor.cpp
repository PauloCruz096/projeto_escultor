...
Sculptor::Sculptor(unsigned _nx, unsigned _ny, unsigned _nz): nx(_nx), ny(_ny), nz(_nz), v(nullptr){
    ...
    for(unsigned i=0; i<nx; i++){
        for(unsigned j=0; i<ny; j++){
            for(unsigned k=0; i<nz; k++){
                v[i][j][k].a = 0.0;
                v[i][j][k].r = 0.0;
                v[i][j][k].g = 0.0;
                v[i][j][k].b = 0.0;
...
void Sculptor::writeOFF(const char* filename){
    ...
    for(unsigned i=0; i<=nx; i++){
        for(unsigned j=0; j<=ny; j++){
            for(unsigned k=0; k<nz; k++){
                if(v[i][j][k].is0n == true){
                    arq << 4 << " " << 0+cont << " " << 3+cont << " " << 2+cont << " " << 1+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    arq << 4 << " " << 4+cont << " " << 5+cont << " " << 6+cont << " " << 7+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    arq << 4 << " " << 0+cont << " " << 1+cont << " " << 5+cont << " " << 4+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    arq << 4 << " " << 0+cont << " " << 4+cont << " " << 7+cont << " " << 3+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    arq << 4 << " " << 3+cont << " " << 7+cont << " " << 6+cont << " " << 2+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    arq << 4 << " " << 1+cont << " " << 2+cont << " " << 6+cont << " " << 5+cont << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << endl;
                    cont+=8;
                }
            }
        }
